...
<table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
            <h2 style="color: green; font-size: 26px;"><strong>Công ty Tuyền Phạm travel</strong></h2>
        </td>
        <td align="right">
            <pre class="font">
               Phone: 0388888091 <br>
               Địa chỉ: Thành phố Hà Nội <br>
               Email:support@tuyenpham.com <br>
            </pre>
        </td>
    </tr>
...
<div class="authority">
    <p>-----------------------------------</p>
    <h5>Hóa đơn được tạo bởi: công ty du lịch Tuyền Phạm</h5>
</div>
</body>
</html>
