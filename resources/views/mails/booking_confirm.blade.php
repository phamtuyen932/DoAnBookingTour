                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column"
                                                    ...
                                                    width="100%">
                                                    <p style="text-align: center; color: white; font-size: 22px">Công ty
                                                        Tuyền Phạm</p>
                                                </td>
                                            </tr>
                                        </tbody>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:42px;">Xác nhận
                                                                                tour</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:16px;">Xin chào
                                                                                <strong><u>{{ $booking->customer->first_name }}</u></strong>,</span>
                                                                        </p>
                                                                        <p
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
                                                                            <span style="font-size:16px;">Tour của bạn
                                                                                đã được xác nhận và lên lịch vào
                                                                                <strong><span
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
                                                                            <span style="font-size:16px;">Nếu bạn có
                                                                                thắc mắc nào có thể liên hệ:
                                                                                <strong><span
                                                                                        style="">01234566789</span></strong>
                                                                                để được hỗ trợ
                                                                            </span>
                                                                        </p>
                                                                        <p
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                lòng xem lại thông tin chi tiết tour ở
                                                                                bên dưới</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <strong><span style="font-size:18px;">Thông
                                                                                    tin tour</span></strong>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 16px; text-align: right;">
                                                                            <strong><span style="font-size:16px;"><span
                                                                                        style="color:#5d77a9;">Ngày
                                                                                        khởi hành</span></span></strong>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 16px; text-align: right;">
                                                                            <strong><span style="font-size:16px;"><span
                                                                                        style="color:#5d77a9;">Khách
                                                                                        hàng</span></span></strong>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 16px; text-align: right;">
                                                                            <strong><span style="font-size:16px;"><span
                                                                                        style="color:#5d77a9;">Số
                                                                                        người</span></span></strong>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 16px; text-align: right;">
                                                                            <strong><span style="font-size:16px;"><span
                                                                                        style="color:#5d77a9;">Tổng
                                                                                        tiền</span></span></strong>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                            ...
                                            <tr>
                                                <td class="column"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="padding-bottom:40px;padding-left:30px;padding-right:30px;padding-top:40px;">
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        style="font-size: 14px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 21px; color: #2f2f2f; line-height: 1.5;">
                                                                        <!-- More content -->
                                            ...
                                            <tr>
                                                <td class="column"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <p
                                                                style="text-align: center; color: white; font-size: 22px">
                                                                Công ty Tuyền Phạm</p>
                                                        </tr>
                                                    </table>
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:12px;">Địa chỉ 12,
                                                                                34567 Thành phố Hà Nội</span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                                            <span
