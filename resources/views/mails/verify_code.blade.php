                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:42px;">Verify
                                                                                Code</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            style="margin-bottom: 10px; font-size: 14px;  mso-line-height-alt: 60px;">
                                                                            <span style="font-size:16px;">Hi
                                                                                {{ $user->name }}</span>
                                                                        </p>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px;  mso-line-height-alt: 80px;">
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px;  mso-line-height-alt: 24px;">
                                                                            <span style="font-size:16px;">
